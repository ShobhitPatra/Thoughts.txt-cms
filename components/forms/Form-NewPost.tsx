...
const FormNewPost = () => {
  return (
    <div className=" max-w-4xl mx-auto ">
      <form className="flex flex-col space-y-2 p-10 h-full w-full bg-slate-200 rounded-lg bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-30 ">
        ...
        <input
          ...
          className="input input-bordered input-accent w-full text-white  md:h-56 flex items-start"
        />
        {/* submit button  */}
        <Button
          variant="ghost"
